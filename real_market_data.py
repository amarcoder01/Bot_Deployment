        ...
        try:
            ...
            market_data = {
                **price_data,
                ...
                'historical_data': hist_data.tail(30).to_dict('records')  # Last 30 days
            }
...
class YahooFinanceSource:
    ...
    async def get_historical(self, symbol: str, period: str, session: aiohttp.ClientSession) -> pd.DataFrame:
